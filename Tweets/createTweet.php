...
<body>
    <div class="card m-5">
        <div class="card-body">
            <form method="post" action="tweetHandler.php">
                <div class="form-group">
                    <label for="tweet">Say Something!</label>
                    <textarea name="tweet" class="form-control" id="tweet" placeholder="Tweet Something!"></textarea>
                </div>
