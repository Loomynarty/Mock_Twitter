...
<body>
    <div class="card m-5">
        <div class="card-body">
            ...
            {
                echo 'Account created successfully! Login in here.';
                unset($_SESSION['success']);
            }
            else if(isset($_SESSION['regiDupe']))
            {
            ...
            else if(isset($_SESSION['longUser']))
            {
            ...
            {
                echo 'Invaild credentials. Please try again.';
